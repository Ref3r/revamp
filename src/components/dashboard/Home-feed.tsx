    ...
    <div className='bg-[#1A1919] h-[160px] w-[630px] rounded-[20px] px-9 pt-4   '>
          <div className='flex flex-col'>
              ...
              <div className=''>
                  ...
                  <div className='flex absolute top-[105px] left-14 '>
                    <Button><Link href="#"><Image src="/add-photos.svg" width={20} height={20} alt='#' /></Link></Button>
                    <Button><Link href="#"><Image src="/mic.svg" width={20} height={20} alt='#'className='ml-4'/></Link></Button>
                  </div>    
              </div>
      </div>
    </div>

...
const Newcommunities = () => {
  ...
  return (
    <div className="w-full  p-6 rounded-lg">
      <h1 className="text-[#FFFFFF] font-bold text-xl sm:text-2xl mb-6">New community</h1>
          ...
          <div key={index} className="flex items-center justify-between gap-4 bg-[#0E0E0E] p-4 rounded-lg">
            <div className="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <h2 className="text-[#FFFFFF] text-sm sm:text-base font-medium truncate">{community.name}</h2>
                <p className="text-[#FFFFFF7A] text-xs sm:text-sm font-medium truncate">{community.description}</p>
              </div>
            </div>
